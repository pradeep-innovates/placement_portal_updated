  ...
  return (
    <>
        ...
        <Routes>
          ...
          <Route exact path="/admin-dashboard" element={<Protectedroute auth={auth}> <Dashboard /> </Protectedroute>} />
          <Route exact path="/logout" element={<Logout setAuth={setAuth}/>} />
          <Route exact path="/student-database" element={<StudentDatabase/>} />
          <Route exact path="/post-announcement" element={<PostAnnouncement/>} />
          <Route exact path="/recruitment" element={<Recruitment/>} />
          <Route exact path="/resumebank" element={<ResumeBuild/>} />
